...
Our variable selection is the same as Explanatory Modeling with the corresponding transformations. We feel that these variables capture most of the variation in the response variable and including any more can lead to overfitting new data.
